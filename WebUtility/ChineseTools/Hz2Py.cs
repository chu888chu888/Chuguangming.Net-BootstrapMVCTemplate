...
namespace WebUtility.ChineseTools
{
    #region 汉字转拼音类
    /// <summary>
    /// 汉字转拼音类
    ...
    public static class Hz2Py
    {
        ...
        public static string Convert(string hzString)
        {
            ...
            int i1 = 0;
            int i2 = 0;
            hzString = FilterString(hzString);
        ...
        /// <returns></returns>
        private static string FilterString(string inputStr)
        {
            ...
            else
            {
                ...
                {
                    inputStr = inputStr.Replace(SpecialCharacters[i], "");
                }
